...
#else
#define errorp(p, ...) errorf(current_file()->name, current_file()->line, pos_string(&p), __VA_ARGS__)
#define warnp(p, ...)  warnf(current_file()->name, current_file()->line, pos_string(&p), __VA_ARGS__)
#endif
